...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    rnn=LSTM(units,return_sequences=True)(input_data)
    rnn=BatchNormalization()(rnn)
    rnn=LSTM(units,return_sequences=True)(rnn)
    rnn=BatchNormalization()(rnn)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    bn_cnn = BatchNormalization(name='bn_conv_1d')(conv_1d)
    bn_cnn=MaxPooling1D(pool_size=2,strides=1,padding='same')(bn_cnn)
    
    simp_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn'))(bn_cnn)
    simp_rnn=Dropout(0.2)(simp_rnn)
    bn_rnn = BatchNormalization(name='bn_rnn')(simp_rnn)
    simp_rnn2 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn2'))(bn_rnn)
    simp_rnn2=Dropout(0.2)(simp_rnn2)
    bn_rnn2 = BatchNormalization(name='bn_rnn2')(simp_rnn2)
    simp_rnn3 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn3'))(bn_rnn2)
    simp_rnn3=Dropout(0.2)(simp_rnn3)
    bn_rnn3 = BatchNormalization(name='bn_rnn3')(simp_rnn3)
    simp_rnn4 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn4'))(bn_rnn3)
    simp_rnn4=Dropout(0.2)(simp_rnn4)
    bn_rnn4 = BatchNormalization(name='bn_rnn4')(simp_rnn4)
    time_dense = TimeDistributed(Dense(256,activation='relu'))(bn_rnn4)
